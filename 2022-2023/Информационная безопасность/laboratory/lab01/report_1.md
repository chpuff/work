...
Задайте размер диска — 20 ГБ (@fig:6).
...
![Команда для получения справки по команде](images/29.jpg){#fig:26 width=100%}
...
![Команда для определения объёма каталога](images/32.jpg){#fig:29 width=100%}
